...
from api.views import UserTypeListView, SchoolListView, MenuListView,\
    HomePageView, FilePolicyAPI, FileUploadCompleteHandler,\
    CustomPageDetailView, CollegeListView, CollegeDetailView,\
    MajorListView, JWTTokenObtainPairSerializer, CareerListView,\
    CareerDetailView

urlpatterns = [

    path('token/', JWTTokenObtainPairSerializer.as_view(),
    ...
    path('files/complete/', FileUploadCompleteHandler.as_view(),
         name='upload-complete'),
    path('pages/<uuid:page_uid>', CustomPageDetailView.as_view(),
         name='custom_page'),
    ...
    path('careers/', CareerListView.as_view(),
         name='careers_list'),
